...
## numeric data type is a catch all for any number value in R, can be decimal integer anything
negative <- -1000
decimal <- 3.14
...
## they are declared by enclosing elements in c(), c stants for concatenate
vector <- c(1, 5, 9, 1) 
...
age <- 20
birthday <- "02/24/2002"
vector <- ThreeFavColors("Red", "Green", "Blue") 
```
